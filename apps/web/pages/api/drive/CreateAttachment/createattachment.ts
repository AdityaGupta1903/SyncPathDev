...
export default async function handler(req: NextApiRequest, res: NextApiResponse<ResponseData>) {
  try {
   ...
   const timeout =  setTimeout(() => {  /// Added timeout because Adding Entry to db is taking time to avoid the duplication of Entries we have used or can add BullMQ(Redis Worker to this)
